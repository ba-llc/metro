...
type Params = {
  params: Promise<{ orgSlug: string; propertySlug: string; channel: string }>;
};

export default async function PublicChannelPage({ params }: Params) {
  const { orgSlug, propertySlug, channel: channelSlug } = await params;
