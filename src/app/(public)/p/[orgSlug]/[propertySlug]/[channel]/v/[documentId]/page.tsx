...
export default async function PublicDocumentVersionPage({ params }: Params) {
  const { orgSlug, propertySlug, channel: channelSlug, documentId } =
    await params;
  ...
  const latestUrl = `/p/${orgSlug}/${propertySlug}/${channelSlug}`;
